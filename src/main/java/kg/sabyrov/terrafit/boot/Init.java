...
public class Init implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User admin = userRepository.save(User.builder()
                .email("terragymkg@gmail.com")
                .password(passwordEncoder.encode("12345"))
                .phoneNumber("+996(554)-488-388")
                .gender("MALE")
...
//                .build());
        ...
        User aigul = userRepository.save(User.builder()
                .email("fitledi@gmail.com")
                .password(passwordEncoder.encode("12345"))
                .phoneNumber("+996(501)-511-932")
                .gender("FEMALE")
        ...
        User vlada = userRepository.save(User.builder()
                .email("stepledi@gmail.com")
                .password(passwordEncoder.encode("12345"))
                .phoneNumber("+996(502)-511-932")
                .gender("FEMALE")
                .birthDate(LocalDate.of(1997, 2, 14))
                .name("Влада")
                .surname("Баланчаева")
        ...
        User karlygash = userRepository.save(User.builder()
                .email("karlygash@gmail.com")
                .password(passwordEncoder.encode("12345"))
                .phoneNumber("+996(500)-500-932")
                .gender("FEMALE")
                .birthDate(LocalDate.of(1997, 2, 14))
                .name("Карлыгаш")
                .surname("Баланчаева")
        ...
        TrainingGroup gymDay = trainingGroupRepository.save(TrainingGroup.builder()
        ...
        TrainingGroup gymEvening = trainingGroupRepository.save(TrainingGroup.builder()
                .trainingGroupCategory(gym)
        ...
        TrainingGroup fitledi = trainingGroupRepository.save(TrainingGroup.builder()
        ...
        TrainingGroup stepAerobika = trainingGroupRepository.save(TrainingGroup.builder()
                .trainingGroupCategory(fitnessGroups)
                .name("Степ-аэробика")
                .subscriptionPrice(new BigDecimal(2000))
        ...
        TrainingGroup crossfitness = trainingGroupRepository.save(TrainingGroup.builder()
                .trainingGroupCategory(fitnessGroups)
                .name("Кроссфит")
                .subscriptionPrice(new BigDecimal(2000))
        ...
        TrainingGroup tkd1 = trainingGroupRepository.save(TrainingGroup.builder()
        ...
        TrainingGroup tkd2 = trainingGroupRepository.save(TrainingGroup.builder()
                .trainingGroupCategory(taekwondo)
                .name("Таэквондо")
                .subscriptionPrice(new BigDecimal(2000))
        ...
        TrainingGroup tkd3 = trainingGroupRepository.save(TrainingGroup.builder()
                .trainingGroupCategory(taekwondo)
                .name("Таэквондо")
                .subscriptionPrice(new BigDecimal(2000))
